...
4. In iADB, tap **Connect a Device** on the welcome screen, then choose **Pair Device** or select the discovered device. Enter the address, pairing port, and six-digit code shown by Android.
